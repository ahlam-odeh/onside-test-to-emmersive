...
document.write(string.split(character).length - 1);
      }
...
function wordsLongerThanThree(str) {
    // TODO: your code here 
     var arr = str.split(" ");
  return filter(arr, function (str, x) {
    return str.length > 3;
  });
}
...
function sayFavoriteFood(object){
  // TODO: your code here
  return object.name + " favorite food is " + object.favoriteFood;
}
...
var circlea = mycircle(20);
var circleb = mycircle(10);
var circlec = [circle1, circle2];
...
function displayBusTimes(busScheduleObj, busLine) {
	// TODO: your code here
   return (
    "The bus will arrive in the next [" + busScheduleObj[busLine] + "] min"
  );
}
...
car.color //dotnotation
car["color"]//bracket
are the same but its more usefull to use the dot notation

//Q2 :What does the typeof operator do?
return the type of any data you enter for example if is 5 rwturn nummber if is array or objegt returns object

//Q3 :How do we add a property to an object?

abjectname.property=value
ex: car.color="red"
